...
uint8_t is_valid_keysize_P(PGM_VOID_P ks_desc, uint16_t keysize) BOOTLOADERLIBS;
uint16_t get_keysize(PGM_VOID_P ks_desc) BOOTLOADERLIBS;
uint16_t get_keysizes(PGM_VOID_P ks_desc, uint16_t** list) BOOTLOADERLIBS;
