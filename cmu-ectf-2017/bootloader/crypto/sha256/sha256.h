 ...
 */
void sha256_init(sha256_ctx_t *state) BOOTLOADERLIBS;
 ...
 */
void sha256_nextBlock (sha256_ctx_t *state, const void *block) BOOTLOADERLIBS;
 ...
 */
void sha256_lastBlock(sha256_ctx_t *state, const void *block, uint16_t length_b) BOOTLOADERLIBS;
 ...
 * \param state pointer to the SHA-256 hash context
 */
void sha256_ctx2hash(sha256_hash_t *dest, const sha256_ctx_t *state) BOOTLOADERLIBS;
 ...
 */
void sha256(sha256_hash_t *dest, const void *msg, uint32_t length_b) BOOTLOADERLIBS;
