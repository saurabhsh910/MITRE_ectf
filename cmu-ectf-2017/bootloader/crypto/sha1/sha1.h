 ...
 */
void sha1_init(sha1_ctx_t *state) BOOTLOADERLIBS;
 ...
 */
void sha1_nextBlock (sha1_ctx_t *state, const void* block) BOOTLOADERLIBS;
 ...
 */
void sha1_lastBlock (sha1_ctx_t *state, const void* block, uint16_t length_b) BOOTLOADERLIBS;
 ...
 */
void sha1_ctx2hash (void *dest, sha1_ctx_t *state) BOOTLOADERLIBS;
 ...
 */
void sha1(void *dest, const void* msg, uint32_t length_b) BOOTLOADERLIBS;
