...
//uint32_t rotl32(uint32_t n, uint8_t bits) BOOTLOADERFUNCS;
uint32_t rotl32(uint32_t n, uint8_t bits){
	return ((n<<bits) | (n>>(32-bits)));
}

//uint32_t change_endian32(uint32_t x) BOOTLOADERFUNCS;
...
//uint32_t ch(uint32_t x, uint32_t y, uint32_t z) BOOTLOADERFUNCS;
uint32_t ch(uint32_t x, uint32_t y, uint32_t z){ 
	return ((x&y)^((~x)&z));
}

//uint32_t maj(uint32_t x, uint32_t y, uint32_t z) BOOTLOADERFUNCS;
uint32_t maj(uint32_t x, uint32_t y, uint32_t z){
	return ((x&y)^(x&z)^(y&z));
}

//uint32_t parity(uint32_t x, uint32_t y, uint32_t z) BOOTLOADERFUNCS;
